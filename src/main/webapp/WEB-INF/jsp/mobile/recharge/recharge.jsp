    ...
    <div class="container">
        <div class="userRechargeListBox">
        	<form action="/recharge/rechargeMoney" id="changeBankAreaForm" method="post" onsubmit="return checkForm();">
				<input type="hidden" id="rechargeType" name="rechargeType" value="0" />
				...
				<div class="listForm">
					...
					<div class="listDetail">
						<p class="detailTitle fontColorYellow">
							...
							<span>充值金额</span>
							<c:forEach items="${bankNameList }" var="bankName">
								<input type="hidden" id="bank_minAmount_${bankName.id }" value="${bankName.minAmount }" />
								<input type="hidden" id="bank_maxAmount_${bankName.id }" value="${bankName.maxAmount }" />
							</c:forEach>
							<span class="detailTips fontColorGray" id="initialMoney" style="display: none">单次最低<span id="txtMinAmount"></span>元，最高<span id="txtMaxAmount"></span>元</span>
						</p>
						<div class="labelCondSelect">
